id="aoanet_vizwiz_finetune_taiyin_sample_captionable"
...
python finetune_vizwiz.py --id $id \
    ...
    --dropout_aoa 0.3 \
    --label_smoothing 0.2 \
    --input_json data/vizwiztalk_taiyin_sample_captionable_withCOCO.json \
    --input_label_h5 data/vizwiztalk_taiyin_sample_captionable_withCOCO_label.h5 \
...
python train_vizwiz.py --id $id \
    ...
    --reduce_on_plateau \
    --cached_tokens vizwiz-train-taiyin-sample-captionable-withCOCO-idxs