id="aoanet_vizwiz_taiyin_gt_captionable_epoch20"
...
python train_vizwiz.py --id $id \
    ...
    --dropout_aoa 0.3 \
    --label_smoothing 0.2 \
    --input_json data/vizwiztalk_taiyin_gt_captionable.json \
    --input_label_h5 data/vizwiztalk_taiyin_gt_captionable_label.h5 \
