...
VizWiz_ANN_PATH = '/home/yz9244/Up-Down-Captioner/bottom-up-attention/data/VizWiz/annotations_taiyin_sample_captionable/'
...
if __name__ == "__main__":
  ...
  # input json
  parser.add_argument('--output_json', default='data/vizwiztalk_taiyin_sample_captionable', help='output json file')
  parser.add_argument('--output_h5', default='data/vizwiztalk_taiyin_sample_captionable', help='output h5 file')
